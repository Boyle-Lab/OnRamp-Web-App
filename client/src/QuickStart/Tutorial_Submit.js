...
import SubmitRun from './images/Onramp_Submit.png';
import WorkingScreen from './images/Onramp_Working.png';
	...
	const { classes } = this.props;
		...
		<Grid container spacing={2} alignItems='flex-start' alignContent='flex-start'>
		    ...
		    <Grid item xs={12}>
		            ...
		            Clicking the submit button will initiate the data analysis on the server side.<br/>
		            <img src={SubmitRun} alt="Submit Run!"/><br />
		            While you are waiting, the "Working" screen will display until the analysis is finished. This typically takes 3-15 minutes for an average-sized dataset.<br/>
		            <img src={WorkingScreen} alt="Working Screen"/><br /><br/>
		        </Typography>
	    
                        <Typography align="left" variant="h6">
                            <span className='bold'>Once analysis has completed, your data will load on the results display and you are ready for the next step...</span><br/>
